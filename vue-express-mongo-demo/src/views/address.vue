	...
	<div>
		...
		<nav-bread>
		    ...
		    <modal :mdShow="isMdShow" @close="closeModal">
		      <p slot="message">Are you sure to delete ?</p>
		      <div slot="btnGroup">
		        <a class="btn btn-m" href="javascript:;" @click="delAddress">Yes</a>
		        <a class="btn btn-m" href="javascript:;" @click="isMdShow=false">No</a>
		      </div>
		    </modal>
